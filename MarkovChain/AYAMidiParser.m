...
-(id)init{
    self = [super init];
    if (self) {
        noteEvents = [[NSMutableArray alloc] init];
    }
                ...
                else
                {
                    ...
                    switch (eventType)
                    {
                        ...
                        case CHANNEL_NOTE_ON:
                            ...
                            if (p2!=0) {
                                NSMutableDictionary *noteEvent = [[NSMutableDictionary alloc] init];
                                [noteEvent setObject:@(p1) forKey:@"noteNum"];
                                [noteEvent setObject:@(deltaTime) forKey:@"timestamp"];
                                [noteEvents addObject:noteEvent];
                            }
                            break;
